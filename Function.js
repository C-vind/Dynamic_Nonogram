...
function OO() {
    document.getElementById("Opts").style = "background-color:Pink";
...
function PrintSt() {
    ...
    Opt.innerHTML = "<br /><table width=150 border=1 style=background-color:Gray>" +
        ...
        "<img src=O.gif /> <b>: <font color=Pink>O</font> <img src=X.gif /> : <font color=LightBlue>X<br />" +
        ...
        "<button id=OO onclick=OO()><font color=Pink><b>O</button> <button id=XX onclick=XX()><font color=LightBlue><b>X</button>" +
...
function PrintTab() {
    ...
    for (i = 1; i <= Hg; i++)
        Tab.innerHTML = Tab.innerHTML + "<tr> <td valign=middle align=center height=37.5><b>" + i + "</td></tr>";
...
function Hrzt(i, Tab) {
    ...
    Tab.innerHTML = Tab.innerHTML + "<td><font color=Violet><b id=HrzN" + i + "></b></td>";
...
function Vrtc(Tab) {
    ...
    for (j = 1; j <= Wd + 1; j++) {
        Cnt = 0;
        if (j > Wd) {
            Tab.innerHTML = Tab.innerHTML + "<td align=center valign=middle><b><font color=Turquoise id=VrtN" + j + "></font></td>";
            Temp = document.getElementById("VrtN" + j);
            Temp.color = "Orange";
            Temp.innerHTML = "<div id=Found>0</div>Over<br />" + Wins;
        } else {
            Tab.innerHTML = Tab.innerHTML + "<td align=center valign=top><b><font color=Turquoise id=VrtN" + j + "></font></td>";
            Temp = document.getElementById("VrtN" + j);
